      ...
      <div className="w-screen h-screen">
        <div className="relative h-screen overflow-hidden">
          <div className="absolute w-screen h-full top-0 left-0 bg-indigo-800 items-center">
            ...
            <div className="absolute top-[165px] left-[107px] [font-family:'Inter-Bold',Helvetica] font-bold text-white text-[15px] text-center tracking-[0] leading-[21.0px] whitespace-nowrap">
              {email}
            </div>
